...
The project was updated there are now two versions of this portfolio the `index-old.html`, which I don't want to delete because that was my initial idea and I still like it, and the currently used `index.html` which is the newly updated version and I'm satisfied with it.
